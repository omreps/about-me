...
(Полноту чувств можно почерпнуть в этой супер-извстной статье https://hackernoon.com/how-it-feels-to-learn-javascript-in-2016-d3a717dd577f)
...
- Создала новый блок Примерчики JS в Деле
